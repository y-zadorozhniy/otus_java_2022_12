...
class CustomerTest {
    ...
    @Test
    @DisplayName("Check that Customer isn't broken")
    ...
    @Test
    @DisplayName("Object Customer as a key of a map")
    ...
    @Test
    @DisplayName("Sorting by field score, ascending iteration")
    ...
    void mutationTest() {
        ...
        //then
        assertThat(customerService.getSmallest().getKey().getName())
                .isEqualTo(customer2.getName());
    }

    @Test
    @DisplayName("Reverse return")
